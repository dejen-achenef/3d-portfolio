  ...
  return (
    <>
      ...
      <div className="flex items-center min-[1000px]:flex-row flex-col-reverse">
        ...
        >
          Hello! I'm Dejen Achenef, a Addis Ababa-based Full-Stack Developer
